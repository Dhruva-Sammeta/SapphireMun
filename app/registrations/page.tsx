...
import { ArrowRight, Users, Award, Ticket, Lock, Sparkles } from "lucide-react"
      ...
      <section id="registrations" className="pb-16 md:pb-24 pt-0 relative">
        <div className="container max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              <div className="relative h-full rounded-2xl border border-white/10 bg-black/70 backdrop-blur-md p-8 flex flex-col items-center text-center overflow-hidden shadow-2xl">
                <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center mb-6 border border-white/10">
                  <Award className="w-8 h-8 text-white/30" />
                </div>

                <h2 className="text-2xl font-light mb-2 text-white/50">
                  OC
                </h2>
                ...
                <p className="text-sm text-white/30 mb-6 leading-relaxed">
                  Join the organizing committee and help shape the second edition.
                </p>

                <div className="mt-auto px-6 py-2.5 rounded-full border border-white/10 text-sm font-semibold text-white/30 bg-white/5 flex items-center gap-2">
            ...
            >
              <div className="relative h-full rounded-2xl border border-purple-500/20 bg-gradient-to-br from-purple-950/40 via-[#0a1535]/70 to-cyan-950/30 backdrop-blur-md p-8 flex flex-col items-center text-center overflow-hidden shadow-2xl">
                ...
                <p className="text-sm text-white/30 mb-6 leading-relaxed relative z-10">
                  A special pass for social events, networking, and the full Sapphire experience.
                </p>
