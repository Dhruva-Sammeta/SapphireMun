...
/* ─── VizagCommitteeCard ─── */
function VizagCommitteeCard({ item }: { item: any }) {
    ...
    const displayText = isRevealed ? item.title : item.cipher
    ...
    return (
        ...
        >
            ...
            <div className="absolute -top-8 -right-8 w-24 h-24 rounded-full bg-red-400/5 blur-2xl group-hover:bg-red-400/15 transition-colors duration-700 pointer-events-none" />
            ...
            <div className="space-y-3 z-10 relative">
                ...
                <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300 ${
                        isRevealed
                            ? "bg-red-500/15 text-red-400 group-hover:scale-110 group-hover:bg-red-500/25"
                            : "bg-red-900/10 text-red-500/40 group-hover:scale-110"
                    }`}>
                        {isRevealed ? <item.icon className="h-5 w-5" /> : <Lock className="h-5 w-5" />}
                    </div>
                    <div>
                        <HyperText
                            key={hyperKey}
                            ...
                            className={isRevealed
                                ? "text-lg md:text-xl font-bold text-slate-100 group-hover:text-red-300 tracking-wider"
                                : "text-lg font-bold text-red-500/50 group-hover:text-red-400 tracking-widest"
                            }
                            duration={isRevealed ? 600 : 800}
                            animateOnLoad={true}
                        />
                    </div>
                </div>

                <div className="h-px w-full bg-gradient-to-r from-transparent via-red-500/30 to-transparent opacity-50" />
                ...
                {isRevealed ? (
                    <motion.div
                        ...
                        className="space-y-2"
                    >
                        <p className="text-red-200/60 text-xs font-medium italic">{item.fullName || item.title}</p>
                        <p className="text-red-200/80 text-sm font-medium">{item.type_level}</p>
                ...
                {isRevealed && (
                    <motion.div
                        ...
                        className="mt-auto pt-2 border-t border-red-500/10"
                    >
                        <p className="text-xs text-red-400/80 flex items-center gap-2 mt-2 font-medium tracking-wide">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="text-sm text-muted">Dates TBD</div>
                                    </div>
                                    <div className="text-center">
                                        <div className="text-2xl font-semibold flex items-center justify-center gap-2">
                    ...
                    <div className="container px-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 mb-12">
                            {[
                                ...
                                return <VizagCommitteeCard key={item.id} item={item} />
                            })}
                        </div>
                    </div>
                </ChunkSection >
